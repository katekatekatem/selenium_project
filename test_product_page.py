...
#         marks=pytest.mark.xfail(reason="Unknown bug, can't fix now")
#     ),
...
def test_guest_can_add_product_to_basket(browser):
    ...
    page.product_price_should_be_the_same_in_basket()
...
class TestUserAddToBasketFromProductPage():
    ...
    def setup(self, browser):
        ...
        self.login_page.register_new_user(
            str(time.time()) + "@fakemail.org", 'RTY456!!!'
        )
    ...
    def test_user_can_add_product_to_basket(self):
        ...
        self.page.product_name_should_be_in_message()
        self.page.product_price_should_be_the_same_in_basket()
